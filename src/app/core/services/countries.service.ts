...
export class CountriesService {
   ...
   * If an error is catched, the error is logged,an empty array is added to gitcountries$,
   * and an observable of an empty array is returned to handle the error in the component's template.
   *
